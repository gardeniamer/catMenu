			...
			<span class="contentInput" v-for="(value,name,index2) in list2" :key="name" v-if="index2 == index">
				...
				<view class="reproduction"  v-if = "index2 == 4">
					<span class="left" @click.stop = "controlChange(1)">
						<image src="../../static/navigator/selectYes.png" :class="{special: index2 == 4}" mode="" v-show="control == 1"></image>
						<image src="../../static/navigator/yes.png" :class="{special: index2 == 4}" mode="" v-show="control == 0"></image>
						是
					</span>
